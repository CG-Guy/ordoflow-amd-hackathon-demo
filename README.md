...
| See technology application | [docs/API_OVERVIEW.md](docs/API_OVERVIEW.md) + [docs/FUNCTIONAL_SPEC_AI_QUOTE_TO_CASH_COPILOT.md](docs/FUNCTIONAL_SPEC_AI_QUOTE_TO_CASH_COPILOT.md) + [docs/COPILOT_ENRICHMENT.md](docs/COPILOT_ENRICHMENT.md) + [docs/COPILOT_SIDECAR_RUNBOOK.md](docs/COPILOT_SIDECAR_RUNBOOK.md) + `examples/` |
...
│   ├── FUNCTIONAL_SPEC_AI_QUOTE_TO_CASH_COPILOT.md ← product spec (judge-safe)
│   ├── API_OVERVIEW.md            ← non-secret API shapes
│   ├── COPILOT_ENRICHMENT.md      ← optional LLM sidecar contract (AMD / ROCm)
│   └── COPILOT_SIDECAR_RUNBOOK.md ← Track 1 sidecar modes (source in private repo)
